                ...
                <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-3 border-t border-slate-200/80">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.1" min="0" max="5.0" name="rating" value="{{ old('rating', '5.0') }}" placeholder="5.0"
                                   class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#0284C7] bg-white">
                        ...
                        <div>
                            ...
                            <input type="number" min="0" name="sold_count" value="{{ old('sold_count', 0) }}" placeholder="0"
                                   class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#0284C7] bg-white">
                        ...
                        <div>
                            ...
                            <input type="number" min="0" name="review_count" value="{{ old('review_count', 0) }}" placeholder="0"
                                   class="w-full px-4 py-2.5 text-xs rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-[#0284C7] bg-white">
