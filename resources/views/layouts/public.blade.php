        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <a href="https://tiktok.com/@ryokiskincare" target="_blank" class="btn-premium btn-premium-neon shadow-sm text-sm">
                        TikTok Shop
                    </a>
                    @guest
                        <a href="{{ route('login') }}" class="nav-link btn btn-outline-light btn-sm font-mono px-3" style="border-radius: 8px; color: #CCFF00; border-color: rgba(204, 255, 0, 0.3);">_LOGIN</a>
                    @endguest
                    @auth
        ...
        <div x-show="mobileMenuOpen" class="md:hidden bg-[#1E293B] border-t border-white/5" style="display: none;">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <div class="border-t border-white/10 my-2 pt-2">
                    @guest
                        <a href="{{ route('login') }}" class="block px-3 py-2 rounded-md text-base font-mono hover:bg-white/5 transition" style="color: #CCFF00;">_LOGIN</a>
                    @endguest
                    @auth
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        <li class="pt-2 font-mono">WA: +62 812-3456-7890</li>
                ...
                <div>
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="https://tiktok.com/@ryokiskincare" target="_blank" class="w-10 h-10 rounded-full bg-[#1E293B] border border-white/5 flex items-center justify-center hover:bg-[#CCFF00] hover:text-[#020617] transition">
