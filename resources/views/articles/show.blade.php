    ...
    <article class="bg-white p-6 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-8">
        ...
        <div class="bg-gradient-to-r from-sky-50 via-white to-orange-50/40 border border-sky-100/80 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
            ...
            <div class="flex items-center gap-2 shrink-0">
                <a href="https://www.tiktok.com/@ryokijapanskin" target="_blank" rel="noopener noreferrer" onclick="trackTikTokClick('Article CTA', null, 'Skinpedia Detail Page')" class="py-2.5 px-3.5 text-xs font-bold bg-slate-900 hover:bg-slate-800 text-white rounded-xl flex items-center gap-1.5 shadow-sm transition-all hover:scale-105">
