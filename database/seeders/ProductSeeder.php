    ...
    public function run(): void
    {
        $products = [
            ...
            [
                ...
                'description'    => 'Hair tonic yang membantu menutrisi kulit kepala, menguatkan akar rambut, dan memberikan sensasi segar serta tidak lengket.',
                'usage'          => 'Kocok botol sebelum digunakan, Semprotkan langsung ke kulit kepala yang bersih dan kering atau setelah keramas, Pijat lembut selama 1–2 menit agar nutrisi terserap sempurna, Gunakan secara rutin, pagi dan malam, untuk hasil maksimal.',
                'ingredients'    => 'Panax Ginseng Extract, Castor oil, Mentha Piperita Oil, Vitamin B5.',
                'price'          => 256000,
                'category'       => 'Hair Care',
